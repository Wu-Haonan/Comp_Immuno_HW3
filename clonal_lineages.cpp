...
unordered_map<int,int> clonal_lineage_search(const unordered_map<int,set<int>>& Vertex_map){
    unordered_map<int,int> clonal_lineage;
    int component = 1;
...
int main() {
    CDR3Dataset data;
    data.Read_Fasta("/research/hvw5426/Comp_Immuno/Comp_Immuno_HW3/Alignment_results/compressed_cdr3s.fasta");
